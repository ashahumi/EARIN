...
def main():
    ...
    print("="*60)
    print("PROGRESSIVE LEARNING CURVE EXPERIMENT (LOW-DATA CLIFF ZOOM)")
    print("Evaluating Model Breakdown Across Micro-Training Set Sizes")
    ...
    # 3. Define the Micro-Data Progressive Sizes (5,000 down to 500 stepping down by 500)
    sample_sizes = [5000, 4500, 4000, 3500, 3000, 2500, 2000, 1500, 1000, 500]
    ...
    print("\n" + "="*60)
    print("LEARNING CURVE ANALYSIS SUMMARY (MICRO-DATA ZOOM)")
    print("="*60)
